			...
			<div class="card-body">
				...
				<form method="post" action="/dashboard/kategori">
					...
					<div class="form-group">
						...
						<input type="text" name="nama_kategori" class="form-control" autofocus="On" placeholder="Tulis disini ...">
					</div>
					<div class="form-group">
								...
								<tr>
									...
									<td>
										<form method="post" action="{{url('dashboard/kategori/'.$hasil->id)}}">
											@csrf
											@method('delete')
											<a href="{{url('dashboard/kategori/edit/'.$hasil->id)}}" class="btn btn-primary btn-sm">edit</a>
