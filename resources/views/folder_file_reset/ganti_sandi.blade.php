    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-6 col-md-12 col-sm-12">
          <div class="card">
          <div class="card-body">
          <form class="form-signin" method="post" action="{{ url('folder_file_reset/ganti_sandi/' . $token) }}">
            @csrf

            <div class="text-center mb-4">
              <h1 class="h3 mb-3 font-weight-normal">Mulai ganti Password</h1>
            </div>

            <div class="form-label-group">
              <input type="email" name="email" id="inputEmail" class="form-control" readonly placeholder="Email address" value="{{request('email')}}">
